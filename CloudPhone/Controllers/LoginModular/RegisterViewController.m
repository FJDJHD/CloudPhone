...
- (void)viewDidLoad {
    ...
    selectButton.frame = CGRectMake(10, CGRectGetMaxY(registerButton.frame), 20, 20);
    [self.view addSubview:selectButton];
    
    UIButton *customerAgreementButton = [UIButton buttonWithType:UIButtonTypeCustom];
    customerAgreementButton.titleLabel.font = [UIFont systemFontOfSize:10.0];
    customerAgreementButton.frame = CGRectMake(120, CGRectGetMaxY(registerButton.frame), MainWidth - 130, 22);
