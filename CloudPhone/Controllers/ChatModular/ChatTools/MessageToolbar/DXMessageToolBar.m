...
//    self.inputTextView.contentMode = UIViewContentModeCenter;
    ...
    _inputTextView.placeHolder = NSLocalizedString(@"输入新消息", @"input a new message");
    ...
    if (!self.moreView) {
        ...
        self.moreView.backgroundColor = [UIColor colorWithRed:240/255.0 green:242/255.0 blue:247/255.0 alpha:1];
    ...
    if (!self.faceView) {
        ...
        self.faceView.backgroundColor = [UIColor colorWithRed:240/255.0 green:242/255.0 blue:247/255.0 alpha:1];
